...
export default function RegisterJobseekerPage() {
  ...
  const register_ = useMutation({
    mutationFn: (data: FormData) => authApi.registerJobseeker(data),
    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          <h1 className="text-2xl font-bold text-gray-900">求職者として登録</h1>
          <p className="mt-2 text-sm text-gray-500">
            企業として登録する場合は
            <Link href="/auth/register/company" className="text-blue-600 hover:text-blue-800 ml-1">
              こちら
            </Link>
          </p>
